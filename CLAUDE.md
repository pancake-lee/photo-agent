...
- **评估模式** — 触发：`评估`、`我发现问题`、`这里不够好`、`效果不对`、`有个 bug`
  - 读：backlog.md、design/*、相关代码
  - 产出：backlog 新条目（含分析结论）
- **规划模式** — 触发：`规划一下`、`帮我设计`、`出个方案`、`怎么做`
  - 读：backlog.md、prd.md、tech.md、note.md
  - 产出：design/*.md、backlog 条目更新
- **生成模式** — 触发：`按方案执行`、`开始开发`、`实现这个`
