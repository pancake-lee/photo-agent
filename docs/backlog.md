...
| 状态   | 分组       | 编号  | 任务                                         | 评估 |
| ------ | ---------- | ----- | -------------------------------------------- | ---- |
| 已规划 | Agent Runtime | AR3-1 | 目标契约与通用任务状态拆分                |      |
| 已规划 | Agent Runtime | AR3-2 | Capability 分层与既有能力契约迁移         |      |
| 已规划 | Agent Runtime | AR3-3 | 照片跨期对比开放目标接入                  |      |
| 已规划 | Agent Runtime | AR3-4 | 主题发现 Workflow 能力化                  |      |
| 已规划 | Agent Runtime | AR3-5 | V3 组合轨迹评估与回归基线                 |      |
