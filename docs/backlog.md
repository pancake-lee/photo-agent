...
| 已规划 | 图文工坊   | PS2  | 图片管理选择模式                       |      |
| 已规划 | 图文工坊   | PS3  | 主题发现采纳入口                       |      |
| 已规划 | 图文工坊   | PS4  | 导出功能                               |      |
| 已规划 | 图文工坊   | PS6  | 文案生成提示词结构重构                 |      |
...
- **验收**：
  ...
  - [ ] 照片全部无描述时返回明确错误提示，部分无描述时弹出警告
  - [ ] LLM 输出带围栏或寒暄时标题正文仍能正确拆分
  - [ ] 日志可见照片数、缺描述数、提示词长度
