...
- **RAG 检索**：黄金用例 ✅ 已有，LLM-judge 不需要，启发式 可选，结构化追踪 ✅ 已有基础
- **Text-to-SQL**：黄金用例 ✅ 主要，LLM-judge 辅助，启发式 可选，结构化追踪 待建设
- **Agent 路由**：黄金用例 ✅ 主要，LLM-judge 不需要，启发式 不需要，结构化追踪 待建设
- **聚类标题**：黄金用例 可选，LLM-judge 暂缓，启发式 ✅ 第一道门禁，结构化追踪 待建设
- **对话回复**：黄金用例 可选，LLM-judge 暂缓，启发式 可选，结构化追踪 待建设
- **管道正确性**：黄金用例 不需要，LLM-judge 不需要，启发式 ✅ 主要，结构化追踪 ✅ 主要
